...
def test_mp_v3_hasher_has_the_same_hash(fixture_mapping_package_v3_model: MappingPackageV3Lightweight):
    hasher = MappingPackageV3LightweightHasher(fixture_mapping_package_v3_model)
...
def test_mp_v3_hasher_initialization_with_custom_hasher(fixture_mapping_package_v3_model):
    ...
    hasher = MappingPackageV3LightweightHasher(fixture_mapping_package_v3_model, custom_hasher)
...
def test_mp_v3_hasher_hash_file_path_sorting(fixture_mapping_package_v3_model):
    ...
    hasher = MappingPackageV3LightweightHasher(fixture_mapping_package_v3_model, mock_hasher)
    hasher.hash()
...
def test_mp_v3_hasher_real_sha256_hash_format(fixture_mapping_package_v3_model):
    hasher = MappingPackageV3LightweightHasher(fixture_mapping_package_v3_model, SHA256Hasher())
    result = hasher.hash()
...
def test_mp_v3_hasher_uses_only_package_metadata_for_hashing(fixture_mapping_package_v3_model: MappingPackageV3Lightweight):
    hasher = MappingPackageV3LightweightHasher(fixture_mapping_package_v3_model)
