...
class MappingPackageV2MetadataSerialiser(MappingPackageAssetSerialiser):
    """Serialiser for mapping package metadata."""

    def serialise(self, package_folder_path: Path, asset: MappingPackageV2Metadata) -> None:
...
@traced_class
class MappingPackageV2Serialiser(MappingPackageAssetSerialiser):
    """Main serialiser for complete mapping packages."""

    def serialise(self, package_folder_path: Path, asset: MappingPackageV2) -> None:
        ...
        MappingPackageV2MetadataSerialiser().serialise(package_folder_path, asset.metadata)
