"""
MongoDB repository adapter for MappingPackageV1.

This module provides a MongoDB repository implementation for loading and saving
MappingPackageV1 instances to/from MongoDB collections.
"""
...
PACKAGE_VERSION = "v1"
DEFAULT_COLLECTION_NAME = "mapping_packages_v1"


@traced_class
class MappingPackageV1Repository(RepositoryABC[MappingPackageV1]):
    """
    MongoDB repository for MappingPackageV1 instances.

    This repository handles CRUD operations for MappingPackageV1 objects,
    ...
    def __init__(
        ...
        """
        Initialize the MappingPackageV1 repository.

        Args:
            mongo_client: MongoDB client instance
            database_name: Name of the MongoDB database
            collection_name: Optional collection name. Defaults to 'mapping_packages_v1'
        """
    ...
    def create(self, model: MappingPackageV1) -> str:
        """
        Create a new mapping package in MongoDB.

        Args:
            model: The MappingPackageV1 instance to save
    ...
    def read(self, model_id: str) -> MappingPackageV1:
        """
        ...
        return MappingPackageV1.model_validate(result)

    def read_many(self, filters: Optional[Dict[str, Any]] = None) -> List[MappingPackageV1]:
        """
        ...
        Returns:
            List of MappingPackageV1 instances
        """
        query = filters or {}
        ...
        for doc in results:
            ...
            models.append(MappingPackageV1.model_validate(doc))

        return models

    def update(self, model: MappingPackageV1) -> MappingPackageV1:
        """
        Update an existing mapping package in MongoDB.

        Args:
            model: The MappingPackageV1 instance to update

        Returns:
            The updated MappingPackageV1 instance
