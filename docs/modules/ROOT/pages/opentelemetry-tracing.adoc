...
SDK operations (loading, conversion, validation, etc.) are traced when tracing is enabled. Use the shortcut or version-specific loaders as usual; they are automatically traced.
