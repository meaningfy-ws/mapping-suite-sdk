...
@traced_routine
def load_mapping_package_v2_from_folder(
    ...
    Returns:
        MappingPackageABC: The loaded mapping package containing all components including
    ...
    mapping_package_loader = mapping_package_loader or MappingPackageV2Loader()

    return mapping_package_loader.load(mapping_package_folder_path)


@traced_routine
def load_mapping_package_v2_from_archive(
...
def load_mapping_packages_v2_from_github(
    ...
    Returns:
        List[MappingPackageABC]: A list of loaded mapping packages. Each package
    ...
    with github_extractor.extract_temporary(repository_url=github_repository_url,
        ...
        mapping_packages: List[MappingPackageV2] = []
...
def load_mapping_package_v2_from_mongo_db(
        ...
        mapping_package_repository: MongoDBRepository[MappingPackageV2]
) -> MappingPackageV2:
    """
