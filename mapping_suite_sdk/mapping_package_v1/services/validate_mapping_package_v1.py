...
from mapping_suite_sdk.mapping_package_v1.services.load_mapping_package_v1 import load_mapping_package_v1_from_archive, \
    load_mapping_package_v1_from_folder, load_mapping_packages_v1_from_github
from mapping_suite_sdk.mapping_package_v1.services.serialise_mapping_package_v1 import \
...
@traced_routine
def validate_mapping_package_v1(
        mapping_package: MappingPackageV1,
        mp_validator: Optional[MappingPackageV1Validator] = None) -> Literal[True] | NoReturn:
    """
...
@traced_routine
def validate_mapping_package_v1_from_archive(
        mapping_package_archive_path: Path,
        mp_validator: Optional[MappingPackageV1Validator] = None,
    ...
    mapping_package: MappingPackageV1 = load_mapping_package_v1_from_archive(
    ...
    return validate_mapping_package_v1(mapping_package=mapping_package, mp_validator=mp_validator)


@traced_routine
def validate_mapping_package_v1_from_folder(
        mapping_package_folder_path: Path,
        mp_validator: Optional[MappingPackageV1Validator] = None,
        mapping_package_loader: Optional[MappingPackageV1Loader] = None) -> Literal[True] | NoReturn:
    ...
    mapping_package: MappingPackageV1 = load_mapping_package_v1_from_folder(
...
@traced_routine
def validate_bulk_mapping_packages_v1_from_folder(
    ...
    for mp_folder in mapping_packages_folder_path.iterdir():
        try:
            validate_mapping_package_v1_from_folder(mapping_package_folder_path=mp_folder,
...
@traced_routine
def validate_bulk_mapping_packages_v1_from_github(
    ...
    mapping_packages: List[MappingPackageV1] = load_mapping_packages_v1_from_github(
