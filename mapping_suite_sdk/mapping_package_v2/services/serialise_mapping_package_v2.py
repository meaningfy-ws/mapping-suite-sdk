...
from mapping_suite_sdk.mapping_package_v2.adapters.mp_v2_serialiser import MappingPackageV2Serialiser
from mapping_suite_sdk.mapping_package_v2.models.mapping_package_v2 import MappingPackageV2


@traced_routine
def serialise_mapping_package_v2(mapping_package: MappingPackageV2,
    ...
    with tempfile.TemporaryDirectory() as temp_directory:
        ...
        MappingPackageV2Serialiser().serialise(temp_directory_path, mapping_package)

        archive_unpacker.pack_directory(temp_directory_path, serialisation_folder_path)


@traced_routine
def serialise_mapping_package_v2_to_folder(mapping_package: MappingPackageV2,
    ...
    Returns:
        None
    """
    MappingPackageV2Serialiser().serialise(serialisation_folder_path, mapping_package)
