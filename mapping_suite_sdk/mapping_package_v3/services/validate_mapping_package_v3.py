...
def validate_mapping_package_v3(
        ...
        mp_validator: Optional[MappingPackageV3Validator] = None) -> Literal[True] | NoReturn:
    """
...
def validate_mapping_package_v3_from_archive(
    ...
    mapping_package: MappingPackageV3 = load_mapping_package_v3_from_archive(
...
def validate_mapping_package_v3_from_folder(
    ...
    mapping_package: MappingPackageV3 = load_mapping_package_v3_from_folder(
    ...
    for mp_folder in mapping_packages_folder_path.iterdir():
        try:
            validate_mapping_package_v3_from_folder(mapping_package_folder_path=mp_folder,
                                                    ...
                                                    mapping_package_loader=mapping_package_loader, )
        except MPV3HashValidationException as hash_validation_exception:
            ...
            if update_hash:
                ...
                metadata['mapping_suite_hash_digest'] = MappingPackageV3Hasher(
...
def validate_bulk_mapping_packages_v3_from_github(
    ...
    mapping_packages: List[MappingPackageV3] = load_mapping_packages_v3_from_github(
