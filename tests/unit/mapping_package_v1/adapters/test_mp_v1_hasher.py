...
def test_mp_v1_hasher_initialization_with_default_hasher(dummy_mapping_package_v1_model):
    ...
    assert hasher.mapping_package == dummy_mapping_package_v1_model
    assert isinstance(hasher.hasher, SHA256Hasher)


def test_mp_v1_hasher_initialization_with_custom_hasher(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")

    custom_hasher = Mock(spec=HasherABC)

    hasher = MappingPackageV1Hasher(dummy_mapping_package_v1_model, custom_hasher)

    assert hasher.mapping_package == dummy_mapping_package_v1_model
    assert hasher.hasher == custom_hasher


def test_mp_v1_hasher_hash_creates_consistent_signature(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_hasher_hash_with_custom_version(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_hasher_hash_uses_package_version(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    original_version = dummy_mapping_package_v1_model.metadata.mapping_version
...
def test_mp_v1_hasher_hash_different_versions_different_hash(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_hasher_hash_includes_all_components(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    hasher = MappingPackageV1Hasher(dummy_mapping_package_v1_model, mock_hasher)
    result = hasher.hash()
    ...
    expected_calls = (
            len(dummy_mapping_package_v1_model.technical_mapping_suite.files) +
            len(dummy_mapping_package_v1_model.vocabulary_mapping_suite.files) +
...
def test_mp_v1_hasher_hash_uses_normalized_content(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_hasher_hash_file_path_sorting(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    technical_files = dummy_mapping_package_v1_model.technical_mapping_suite.files
    vocab_files = dummy_mapping_package_v1_model.vocabulary_mapping_suite.files
...
def test_mp_v1_hasher_hash_with_none_version(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_hasher_real_sha256_hash_format(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")

    hasher = MappingPackageV1Hasher(dummy_mapping_package_v1_model, SHA256Hasher())
    result = hasher.hash()
