"""
Unit tests for MappingPackageV2Saver.
...
class TestMappingPackageV2Saver:
    """Tests for MappingPackageV2Saver."""

    def test_save_from_archive_success(self, dummy_mapping_package_v2_archive_path):
    ...
    def test_save_from_archive_custom_collection_name(self, dummy_mapping_package_v2_archive_path):
    ...
    def test_save_from_archive_custom_extractor(self, dummy_mapping_package_v2_archive_path):
        """Test that custom archive extractor can be provided."""
        mongo_client = mongomock.MongoClient()
        custom_extractor = ArchiveExtractor()

        saver = MappingPackageV2Saver(archive_unpacker=custom_extractor)
        result = saver.save_from_archive(
            mapping_package_archive_path=dummy_mapping_package_v2_archive_path,
            mongo_client=mongo_client,
            database_name="test_db"
    ...
    def test_save_from_archive_uses_package_id(self, dummy_mapping_package_v2_archive_path):
