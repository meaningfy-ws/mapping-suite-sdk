...
class MappingPackageV3LightweightMetadataJSONLD(MappingPackageMetadata, MappingPackageV3Metadata, JSONLDModel):
    """
        This class represents an aggregation of domain model and technical data of Mapping Package V3.
        This model must be used as Mapping Package V3 Lightweight Metadata.
    """
