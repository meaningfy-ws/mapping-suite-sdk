"""
Adapter for saving MappingPackageV3Lightweight from archives to MongoDB.

This adapter handles extraction and loading of v3L (lightweight) mapping packages,
...
class MappingPackageV3LightweightSaver:
    """Saver for MappingPackageV3Lightweight from zip archives to MongoDB."""
    ...
    def save_from_archive(
        ...
        """Load a v3L mapping package from a zip archive and save it to MongoDB.
