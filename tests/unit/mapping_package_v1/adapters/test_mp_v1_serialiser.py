...
from mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser import (
...
def test_mp_v1_metadata_serialiser_creates_metadata_file(dummy_mapping_package_v1_model):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        serialiser = MappingPackageV1MetadataSerialiser()
        serialiser.serialise(temp_path, dummy_mapping_package_v1_model.metadata)

        # Verify metadata file is created
        metadata_path = temp_path / dummy_mapping_package_v1_model.metadata.path
        assert metadata_path.exists()
        assert metadata_path.is_file()


def test_mp_v1_metadata_serialiser_creates_parent_directories(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        metadata = dummy_mapping_package_v1_model.metadata
...
def test_mp_v1_metadata_serialiser_json_format(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_metadata_serialiser_excludes_path_field(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_metadata_serialiser_pretty_formatted(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_metadata_serialiser_excludes_none_values(dummy_mapping_package_v1_model):
    with tempfile.TemporaryDirectory() as temp_dir:
        temp_path = Path(temp_dir)
...
def test_mp_v1_serialiser_creates_all_components(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        serialiser = MappingPackageV1Serialiser()
        serialiser.serialise(temp_path, dummy_mapping_package_v1_model)

        # Verify all major components are created
        assert (temp_path / dummy_mapping_package_v1_model.metadata.path).exists()
        assert (temp_path / dummy_mapping_package_v1_model.conceptual_mapping_asset.path).exists()
        assert (temp_path / dummy_mapping_package_v1_model.technical_mapping_suite.path).exists()
        assert (temp_path / dummy_mapping_package_v1_model.vocabulary_mapping_suite.path).exists()


@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.MappingPackageV1MetadataSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.ConceptualMappingFileAssetSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.TechnicalMappingCollectionAssetSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.VocabularyMappingCollectionAssetSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.TestDataCollectionAssetSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.SAPRQLTestCollectionAssetSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.SHACLTestCollectionAssetSerialiser')
@patch('mapping_suite_sdk.mapping_package_v1.adapters.mp_v1_serialiser.TestResultCollectionAssetSerialiser')
def test_mp_v1_serialiser_calls_all_component_serialisers(
        ...
        dummy_mapping_package_v1_model
):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
...
def test_mp_v1_serialiser_tracer_decoration():
    ...
    assert serialiser.__class__.__name__ == 'MappingPackageV1Serialiser'


def test_mp_v1_serialiser_preserves_file_content(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for tm_file in dummy_mapping_package_v1_model.technical_mapping_suite.files:
        ...
        for vm_file in dummy_mapping_package_v1_model.vocabulary_mapping_suite.files:
        ...
        cm_path = temp_path / dummy_mapping_package_v1_model.conceptual_mapping_asset.path
        assert cm_path.exists()
        assert cm_path.read_bytes() == dummy_mapping_package_v1_model.conceptual_mapping_asset.content


def test_mp_v1_serialiser_creates_directory_structure(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        tech_suite_path = temp_path / dummy_mapping_package_v1_model.technical_mapping_suite.path
        assert tech_suite_path.exists()
        assert tech_suite_path.is_dir()

        vocab_suite_path = temp_path / dummy_mapping_package_v1_model.vocabulary_mapping_suite.path
...
def test_mp_v1_serialiser_handles_test_data_suites(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for test_suite in dummy_mapping_package_v1_model.test_data_suites:
...
def test_mp_v1_serialiser_handles_sparql_test_suites(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for sparql_suite in dummy_mapping_package_v1_model.test_suites_sparql:
...
def test_mp_v1_serialiser_handles_shacl_test_suite(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        shacl_suite = dummy_mapping_package_v1_model.test_suites_shacl
...
def test_mp_v1_serialiser_handles_empty_collections(dummy_mapping_package_v1_model):
    if not isinstance(dummy_mapping_package_v1_model, MappingPackageV1):
        pytest.skip("This test requires a V1 mapping package")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        empty_model = dummy_mapping_package_v1_model.model_copy(deep=True)
...
def test_mp_v1_serialiser_reproduces_original_structure(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Verify suites exist
        assert (temp_path / dummy_mapping_package_v1_model.technical_mapping_suite.path).is_dir()
        assert (temp_path / dummy_mapping_package_v1_model.vocabulary_mapping_suite.path).is_dir()


def test_mp_v1_metadata_serialiser_uses_alias_fields(dummy_mapping_package_v1_model):
