...
class TestSaveMappingPackageV3LightweightToMongoDB:
    ...
    def test_save_mapping_package_v3L_none_client(self, dummy_mapping_package_v3L_archive_path):
    ...
    def test_save_mapping_package_v3L_custom_collection_name(self, dummy_mapping_package_v3L_archive_path):
    ...
    def test_save_mapping_package_v3L_tracer_decoration(self):
    ...
    def test_save_mapping_package_v3L_uses_package_id(self, dummy_mapping_package_v3L_archive_path):
