"""
Unit tests for the save_mapping_package_v2 service.
...
class TestSaveMappingPackageV2ToMongoDB:
    """Tests for saving MappingPackageV2 models to MongoDB."""
    ...
    def test_save_mapping_package_v2_success(self, dummy_mapping_package_v2_model):
        ...
        result = save_mapping_package_v2_to_mongo_db(
    ...
    def test_save_mapping_package_v2_none_client(self, dummy_mapping_package_v2_model):
    ...
    def test_save_mapping_package_v2_custom_collection_name(self, dummy_mapping_package_v2_model):
    ...
    def test_save_mapping_package_v2_tracer_decoration(self):
        """Test that the function is properly decorated with tracer."""
        assert hasattr(save_mapping_package_v2_to_mongo_db, '__name__')
        assert save_mapping_package_v2_to_mongo_db.__name__ == 'save_mapping_package_v2_to_mongo_db'

    def test_save_mapping_package_v2_uses_package_id(self, dummy_mapping_package_v2_model):
