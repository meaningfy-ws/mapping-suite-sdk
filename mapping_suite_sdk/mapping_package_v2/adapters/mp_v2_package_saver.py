"""
Adapter for saving MappingPackageV2 to MongoDB.

This adapter saves v2 mapping package models to MongoDB.
"""
import logging
...
class MappingPackageV2Saver:
    """Saver for MappingPackageV2 to MongoDB."""
    ...
    def save(
        ...
        """Save a v2 mapping package model to MongoDB.
        ...
        repository = GridFSPackageRepository[MappingPackageV2](
