...
class TestMappingPackageV2Saver:
    ...
    def test_save_success(self, dummy_mapping_package_v2_archive_path):
        ...
        with extractor.extract_temporary(dummy_mapping_package_v2_archive_path) as temp_folder:
    ...
    def test_save_custom_collection_name(self, dummy_mapping_package_v2_archive_path):
    ...
    def test_save_uses_package_id(self, dummy_mapping_package_v2_archive_path):
