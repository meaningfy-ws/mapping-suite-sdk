"""
Adapter for saving MappingPackageV1 from archives to MongoDB.

This adapter handles extraction and loading of v1 mapping packages,
...
class MappingPackageV1Saver:
    """Saver for MappingPackageV1 from zip archives to MongoDB."""
    ...
    def save_from_archive(
        ...
        """Load a v1 mapping package from a zip archive and save it to MongoDB.
